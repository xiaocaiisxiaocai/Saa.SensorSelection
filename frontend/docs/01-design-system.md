...
| `--sys-red` | `#FF3B30` | `#FF453A` | 破坏性操作、失败、错误 |
| `--sys-orange` | `#FF9500` | `#FF9F0A` | 警告、「停用」状态 |
| `--sys-yellow` | `#FFCC00` | `#FFD60A` | 待处理 |
...
| `--label-2` | `rgb(60 60 67 / 60%)` | `rgb(235 235 245 / 60%)` | 次要说明、表头 |
...
| Sensor 备选 | `--sys-blue` | 同上 |
| Sensor 停用 | `--sys-orange` | 同上 |
| 反馈 已解决 | `--sys-green` | 厂外反馈状态列 |
| 反馈 处理中 | `--sys-blue` | 同上 |
| 反馈 待处理 | `--sys-yellow` | 同上 |
